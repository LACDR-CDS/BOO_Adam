---
title: "BOO 2025"
subtitle: "Script 7: TXG-MAPr import"
date: "`r Sys.Date()`" 
author: 
  Adam Seuren
output:
...
root_dir <-  "C:/Users/mmpse/Documents/GitHub/BOO-Adam/TXG-MAPr/"

low_store <- "Input/DEGres_low.Rdata"
moderate_store <- "Input/DEGres_moderate.Rdata"

txg_store <- "Output/TXG_upload"
...
load(paste0(root_dir, moderate_store))
...
write_tsv(txg_moderate, file=paste0(root_dir, txg_store, "_moderate.txt"))
...
write_tsv(txg_low, file=paste0(root_dir, txg_store, "_low.txt"))
```
