...
```
In the low toxicity compound, there are 21 significant downregulated genes, and 109 significant upregulated genes. In the moderate toxic compound, there are 99 significant downregulated genes and 38 significant upregulated genes. In total, the moderately toxic compound yields more DEGs, though there is less upregulation and more downregulation.
***
...
A larger spread can be seen in the fifth concentration level of the moderately toxic compound than in the other concentration levels. This may be partly due to the one repetition with low correlation to the other repetitions of the same condition. The genes with the largest differential expression vary per concentration level, although APOA4 can be seen in concentration level 2, 3, and 4. The genes with the largest differential expression are:
...
For the moderately toxic compound, RPL27 does not show anymore. Again, the fifth concentration level shows a larger spread of non-significant genes than the other concentration levels.
***
